...
class TestClimateZoneDetection:
    ...
    def test_extreme_cold_zone_kiruna(self, hass_mock):
        ...
        assert engine.climate_detector.zone_info.winter_avg_low == -30.0
    ...
    def test_very_cold_zone_lulea(self, hass_mock):
        ...
        assert engine.climate_detector.zone_info.winter_avg_low == -15.0
    ...
    def test_cold_zone_stockholm(self, hass_mock):
        ...
        assert engine.climate_detector.zone_info.winter_avg_low == -10.0
    ...
    def test_moderate_cold_zone_copenhagen(self, hass_mock):
        ...
        assert engine.climate_detector.zone_info.winter_avg_low == 0.0
    ...
    def test_standard_zone_paris(self, hass_mock):
        ...
        assert engine.climate_detector.zone_info.winter_avg_low == 5.0
...
class TestDMRangeCalculations:
    ...
    def test_extreme_cold_at_average_temperature(self, hass_mock):
        """Kiruna at -30°C (average winter low) should have normal DM -800 to -1200."""
        engine = create_engine_for_location(67.85, hass_mock)
    ...
    def test_very_cold_at_average_temperature(self, hass_mock):
        """Luleå at -15°C (average winter low) should have normal DM -600 to -1000."""
        engine = create_engine_for_location(65.58, hass_mock)

        dm_range = engine._calculate_expected_dm_for_temperature(-15.0)

        assert -1000 <= dm_range["normal"] <= -600
        assert dm_range["warning"] <= -1000

    def test_cold_at_average_temperature(self, hass_mock):
        """Stockholm at -10°C (average winter low) should have normal DM -450 to -700."""
        engine = create_engine_for_location(59.33, hass_mock)

        dm_range = engine._calculate_expected_dm_for_temperature(-10.0)

        assert -700 <= dm_range["normal"] <= -450
        assert dm_range["warning"] <= -700

    def test_moderate_cold_at_average_temperature(self, hass_mock):
        """Copenhagen at 0°C (average winter low) should have normal DM -300 to -500."""
        engine = create_engine_for_location(55.68, hass_mock)

        dm_range = engine._calculate_expected_dm_for_temperature(0.0)

        assert -500 <= dm_range["normal"] <= -300
        assert dm_range["warning"] <= -500

    def test_standard_at_average_temperature(self, hass_mock):
        """Paris at 5°C (average winter low) should have normal DM -200 to -350."""
        engine = create_engine_for_location(48.85, hass_mock)

        dm_range = engine._calculate_expected_dm_for_temperature(5.0)
    ...
    def test_temperature_adjustment_warmer_than_average(self, hass_mock):
        """Stockholm at 0°C (warmer than -10°C average) should allow shallower DM."""
        engine = create_engine_for_location(59.33, hass_mock)

        dm_warm = engine._calculate_expected_dm_for_temperature(0.0)
        dm_avg = engine._calculate_expected_dm_for_temperature(-10.0)
    ...
    def test_temperature_adjustment_colder_than_average(self, hass_mock):
        """Stockholm at -20°C (colder than -10°C average) should allow deeper DM."""
        engine = create_engine_for_location(59.33, hass_mock)

        dm_cold = engine._calculate_expected_dm_for_temperature(-20.0)
        dm_avg = engine._calculate_expected_dm_for_temperature(-10.0)
...
class TestArcticScenario:
    ...
    def test_dm_minus_400_is_shallow_in_kiruna(self, hass_mock):
        """In Kiruna at -30°C, DM -400 is unusually shallow (might indicate problem)."""
        engine = create_engine_for_location(67.85, hass_mock)
...
class TestStandardScenario:
    """Test Standard scenario: DM -400 at 0°C should trigger warning."""

    def test_dm_minus_400_triggers_warning_in_paris(self, hass_mock):
        """In Paris at 0°C, DM -400 should be approaching or beyond warning threshold."""
        engine = create_engine_for_location(48.85, hass_mock)

        dm_range = engine._calculate_expected_dm_for_temperature(0.0)

        # DM -400 should be deeper than normal range for mild climate
        # Standard zone at 0°C (5°C colder than average): normal is around -300 to -450
        # So -400 might be within deep normal or approaching warning
        assert dm_range["warning"] <= -400  # Warning threshold is deeper (more negative)

    def test_dm_minus_300_is_normal_in_paris(self, hass_mock):
        """In Paris at 0°C, DM -300 should be within normal range."""
        engine = create_engine_for_location(48.85, hass_mock)
    ...
    def test_copenhagen_vs_paris_same_temperature(self, hass_mock):
        """Copenhagen (moderate_cold) should allow deeper DM than Paris (standard) at 0°C."""
