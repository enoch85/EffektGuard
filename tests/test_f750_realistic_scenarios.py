...
class TestF750RealisticScenarios:
    ...
    def test_cop_calculation_across_temperatures(self, f750):
        ...
        print("=" * 80)
        print(f"{'Outdoor Temp':>15} | {'Expected COP':>12} | {'Calculated COP':>15} | {'Match':>6}")
        print("-" * 80)
        ...
        for outdoor_temp, expected_cop in test_cases:
            ...
            print(f"{outdoor_temp:>13}°C | {expected_cop:>12.1f} | {calculated_cop:>15.2f} | {match:>6}")
            
            assert abs(calculated_cop - expected_cop) < 0.1, \
                f"COP mismatch at {outdoor_temp}°C"
    ...
    def test_interpolation_between_points(self, f750):
        ...
        assert abs(cop_at_minus_2_5 - expected) < 0.01, \
    ...
    def test_electrical_consumption_within_20a_limit(self, f750, house):
        ...
        print("=" * 80)
        print(f"{'Outdoor':>8} | {'Heat Demand':>12} | {'COP':>6} | {'Electrical':>12} | {'Within Limit':>13}")
        print("-" * 80)
    ...
    def test_swedish_climate_scenarios(self, f750, house):
        ...
        print("=" * 80)
        print(f"{'Scenario':25} | {'Out':>5} | {'DM':>6} | {'Demand':>7} | {'COP':>5} | "
        ...
        for scenario, outdoor, dm in scenarios:
            ...
            print(f"{scenario:25} | {outdoor:>4}°C | {dm:>6} | {heat_demand:>5.1f}kW | "
    ...
    def test_auxiliary_heating_threshold(self, f750, house):
        ...
        print("=" * 80)
        print(f"{'Outdoor':>8} | {'Heat Demand':>12} | {'F750 Max':>12} | {'Shortfall':>12} | {'Aux Needed':>12}")
        print("-" * 80)
        ...
        for temp in range(5, -35, -5):
            ...
            print(f"{temp:>6}°C | {heat_demand:>10.2f} kW | {max_heat:>10.2f} kW | "
    ...
    def test_dm_thresholds_with_real_conditions(self, f750, house):
        ...
        class MockPriceAnalyzer:
            def update_prices(self, data): pass
            def get_current_classification(self, quarter): return "normal"
            def get_base_offset(self, quarter, classification, is_daytime): return 0.0
        ...
        class MockThermalModel:
            thermal_mass = 1.0
            def calculate_preheating_target(self, *args, **kwargs): return 21.0
        ...
        print("=" * 80)
        print(f"{'Location':20} | {'Out':>5} | {'DM':>6} | {'Expected DM':>12} | "
        ...
        for location, outdoor, dm in test_cases:
            ...
            print(f"{location:20} | {outdoor:>4}°C | {dm:>6} | {expected['normal']:>12.0f} | "
...
if __name__ == "__main__":
    ...
    for temp in [5, 0, -10, -20, -30]:
        ...
        print(f"  {temp:>3}°C: Demand {demand:.1f}kW, COP {cop:.2f}, "
