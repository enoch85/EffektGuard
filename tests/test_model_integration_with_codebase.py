...
class TestModelThermalDebtIntegration:
    ...
    def test_all_models_aware_of_thermal_debt_thresholds(self):
        ...
        print(
            "Key thresholds: "
            f"start {DM_THRESHOLD_START}, extended {DM_THRESHOLD_EXTENDED}, "
    ...
    def test_models_power_validation_considers_outdoor_temp(self):
        ...
        print("=" * 80)
        print(f"{'Outdoor Temp':>13} | {'Power Draw':>11} | {'Flow Temp':>10} | "
        ...
        for outdoor, power, flow, expected_reason in test_cases:
            ...
            print(f"{outdoor:>11}°C | {power:>9.1f} kW | {flow:>8}°C | "
                  f"{status:>6} | {message:40}")
            ...
            if outdoor > 5:
                ...
                assert result.suggestions is not None or not result.valid, \
...
class TestModelFlowTemperatureIntegration:
    ...
    def test_models_flow_temp_in_realistic_range(self):
        ...
        for model_id in ["nibe_f750", "nibe_f2040", "nibe_s1155"]:
            ...
            print("-" * 80)
            print(f"{'Outdoor':>8} | {'Indoor':>7} | {'Flow (UFH)':>12} | "
            ...
            for outdoor, indoor in test_scenarios:
                ...
                # Test UFH
                flow_ufh = model.calculate_optimal_flow_temp(
                    outdoor, 
                    indoor,
                    heat_demand_ufh_kw
                )
                ...
                flow_rads = model.calculate_optimal_flow_temp(
                    outdoor,
                    indoor,
                    heat_demand_rads_kw
                )
                ...
                print(f"{outdoor:>6}°C | {indoor:>5}°C | {flow_ufh:>10.1f}°C | "
    ...
    def test_models_flow_temp_increases_as_outdoor_temp_drops(self):
        ...
        for outdoor in range(10, -25, -5):
            ...
            flow = f750.calculate_optimal_flow_temp(
                outdoor,
                indoor,
                heat_demand_kw
            )
...
class TestModelCapacityAndSizing:
    ...
    def test_models_detect_insufficient_capacity(self):
        ...
        print("-" * 80)
        print(f"{'Outdoor':>8} | {'Heat Demand':>12} | {'Expected Power':>15} | "
        ...
        for outdoor in [5, 0, -5, -10, -15, -20]:
            ...
            result = f730.validate_power_consumption(
                electrical_needed if electrical_needed <= f730.typical_electrical_range_kw[1]
    ...
    def test_gshp_more_efficient_than_ashp_in_cold(self):
        ...
        print("=" * 80)
        print(f"{'Outdoor':>8} | {'ASHP COP':>9} | {'GSHP COP':>9} | "
        ...
        for outdoor in [10, 0, -10, -20, -30]:
            ...
            print(f"{outdoor:>6}°C | {cop_ashp:>9.2f} | {cop_gshp:>9.2f} | "
                  f"{advantage_pct:>8.1f}% | {status:>12}")
            
            # GSHP should be better or equal in all conditions
            assert cop_gshp >= cop_ashp - 0.1, \
                f"GSHP should not be worse than ASHP at {outdoor}°C"
...
class TestModelDecisionEngineIntegration:
    ...
    def test_models_provide_validation_for_decision_engine(self):
        ...
        for scenario_name, power, outdoor, flow, expected_severity, expected_action in scenarios:
            ...
            print(f"{scenario_name:30} | {power:>5.1f}kW | {status:>6} | "
            ...
            if power > 6.0:
                ...
                assert not result.valid or result.severity == "warning", \
...
class TestRealWorldIntegrationScenarios:
    ...
    def test_stevedvo_thermal_debt_scenario(self):
        ...
        assert not result.valid or result.severity in ["warning", "error"], \
