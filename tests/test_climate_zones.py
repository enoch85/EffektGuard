...
class TestClimateZoneDetection:
    ...
    def test_extreme_cold_zone_kiruna(self):
        ...
        assert detector.zone_info.winter_avg_low == -30.0
    ...
    def test_very_cold_zone_lulea(self):
        ...
        assert detector.zone_info.winter_avg_low == -15.0
    ...
    def test_cold_zone_stockholm(self):
        ...
        assert detector.zone_info.winter_avg_low == -10.0
    ...
    def test_moderate_cold_zone_copenhagen(self):
        ...
        assert detector.zone_info.winter_avg_low == 0.0
    ...
    def test_standard_zone_paris(self):
        ...
        assert detector.zone_info.winter_avg_low == 5.0
...
class TestDMRangeCalculations:
    ...
    def test_extreme_cold_at_average(self):
        ...
        detector = ClimateZoneDetector(67.85)
        dm_range = detector.get_expected_dm_range(-30.0)
    ...
    def test_cold_at_average(self):
        ...
        detector = ClimateZoneDetector(59.33)
        dm_range = detector.get_expected_dm_range(-10.0)
    ...
    def test_moderate_cold_at_average(self):
        ...
        detector = ClimateZoneDetector(55.68)
        dm_range = detector.get_expected_dm_range(0.0)
    ...
    def test_temperature_adjustment_warmer(self):
        ...
        detector = ClimateZoneDetector(59.33)  # Stockholm, winter avg -10°C

        # At average
        dm_at_avg = detector.get_expected_dm_range(-10.0)

        # 10°C warmer than average
        dm_warmer = detector.get_expected_dm_range(0.0)
    ...
    def test_temperature_adjustment_colder(self):
        ...
        dm_colder = detector.get_expected_dm_range(-20.0)
    ...
    def test_extreme_cold_adjustment(self):
        ...
        detector = ClimateZoneDetector(67.85)  # Kiruna, winter avg -30°C

        # At average (-30°C)
        dm_at_avg = detector.get_expected_dm_range(-30.0)

        # At -40°C (10° colder)
        dm_extreme = detector.get_expected_dm_range(-40.0)
    ...
    def test_never_exceeds_absolute_maximum(self):
        ...
        # Even at ridiculous temperatures
        dm_range = detector.get_expected_dm_range(-50.0)
