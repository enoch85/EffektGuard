...
class TestEdgeCases:
    ...
    def test_check_cooldown_very_long_period(self, clear_service_timestamps):
        ...
        with freeze_time(base_time):
            ...
            is_allowed, remaining = effektguard_module._check_service_cooldown("test_service", 1440)  # 24 hours
...
def test_correct_cooldown_constants(
    ...
    with freeze_time(base_time):
        ...
        is_allowed, remaining = effektguard_module._check_service_cooldown(service_name, cooldown_minutes)
