...
class ScenarioTester:
    ...
    def __init__(
        ...
        self.tolerance_range = self.tolerance * 0.4  # 5 * 0.4 = 2.0°C range
    ...
    def calculate_proactive_layer(self, nibe_state: MockNibeState) -> LayerVote:
        ...
        # Simplified expected DM (same as emergency)
        if outdoor < 0:
            expected_normal = -300
        else:
    ...
    def calculate_price_layer(self, price_data: MockPriceData) -> LayerVote:
        ...
        tolerance_factor = self.tolerance / 5.0  # 0.2-2.0 range
